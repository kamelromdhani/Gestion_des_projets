                    ...
                    <div class="col-lg-6">
						...
						<form name="f1" method="post" action=''>
							...
							<legend>PROJECT DETAILS</legend>
                                ...
                                <input class="form-control" type="text" name="project_name" placeholder="PROJECT/ACTIVITY NAME :">
								 <label>PROJECT/ACTIVITY MANAGER : </label>
                                <input class="form-control" type="text" name="project_manager" placeholder="PROJECT/ACTIVITY MANAGER : ">
								 <!--<label>MANAGER :</label>
                                <input class="form-control" type="text" name="manager" placeholder="MANAGER :">-->
								<label>PROJECT CODE : </label>
                                <input class="form-control" type="text" name="project_code" placeholder="PROJECT CODE :">
								<div class="form-group">
...
while ($donnees=$req->fetch())
{
  ...
  <?php
	...
	?>
                                ...
                                <input type="date" name="report_date" class="form-control" placeholder="REPORT DATE :">
								</fieldset>
                            </div>
							...
							<legend>SCOPE MANGMENT</legend>
                                ...
                                <textarea class="form-control" type="text" name="project_description"   rows="10"></textarea>
								 <div class="col-lg-6">
                        <label>PROJECT RAG STATUS</label>
                            ...
                            <table class="table table-bordered table-hover table-striped">
							 ...
							 <table class="table table-bordered table-hover table-striped">
								...
								<tr>
										<td>Date</td>
										<td><input type="date" name="PassedMilestoneDate" id="PassedMilestoneDate"/></td>
										<td><input type="date" name="PlannedMilestoneDate" id="PlannedMilestoneDate"/></td>
								</tr>
								<tr>
											<td>milestone</td><td>
								...
								<legend>KEY ACHIEVMENT/PROGRESS</legend>
									...
									<textarea class="form-control" type="text" name="kap_description" rows="10"></textarea>
									<label>DELIVRABLE NAME 1 :</label>
                                <input class="form-control" type="text" name="DELIVRABLE_NAME1" placeholder="DELIVRABLE NAME 1 :">
								<label>DELIVRABLE NAME 2 :</label>
                                <input  class="form-control" type="text" name="DELIVRABLE_NAME2" placeholder="DELIVRABLE NAME 2 :">
								<legend>NEXT STEP</legend>
								<label>DESCRIPTION </label>
									<textarea class="form-control" type="text" name="ns_description"  rows="10"></textarea>
									<legend>POTENTIEL RED FLAG</legend>
								<label>DESCRIPTION </label>
									<textarea class="form-control" type="text" name="prf_description" rows="10"></textarea>
								<legend>OTHER COMMENT(IF ANY)</legend>
								<label>DESCRIPTION </label>
									<textarea class="form-control" type="text" name="oc_description" rows="10"></textarea>
								</fieldset>
                           ...
                           <!--  <div class="form-group">
							...
							<button type="submit" onclick="f1.action='projetadd.php'"  class="btn btn-primary btn-lg">add project</button>
