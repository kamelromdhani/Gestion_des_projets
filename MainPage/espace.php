...
<body>
<?php 
if(isset ($_SESSION['login']) AND $_SESSION['login']=="admin" AND isset ($_SESSION['pass']) AND $_SESSION['pass']=="admin")
  {
 /* echo $_POST['login'];
  echo $_POST['pass'];*/
  ?>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                 <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="espace.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="projetcons.php">consult a project</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="dem" class="collapse">
                            ...
                            <li>
                                <a href="membre.php">consult members</a>
                            </li>
