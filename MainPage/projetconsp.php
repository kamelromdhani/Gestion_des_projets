...
<body>
    ...
    <div id="wrapper">
		...
		<form name="f1" method="post" action=''> 
            ...
            <button class="btn btn-default"  onclick="f1.action='projetcons.php'" type="submit" name="searchbu" id="searchbu"><i class="glyphicon glyphicon-search"></i></button>
        </form>  
        </div>
		<div class="container">
  <h2>Result :</h2>
...
name =? OR manager =? OR code =? OR report_date =? OR SchedualList =? OR CostList =? OR QualityList =? or optionsRadios=? or direction =?  ');
