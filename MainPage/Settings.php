            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
						...
						<h3>new direction: </h3>
					       <input class="form-control"name="direction" placeholder="direction:">
                             <p><button type="submit" onclick="f2.action='direction.php'" class="btn btn-primary btn-lg"> add direction  </button>
							 <button type="submit" onclick="f2.action='directionsup.php'" class="btn btn-primary btn-lg"> delete direction  </button>
                             </p>
					   </form>
					   <?php }?>
